  ...
  items: [
    {
      ...
      image: { src: '/images/potentials/editorial_documentary_landscape_photograph_of_a_traditional_rubber_plantation.png', alt: 'Petani menderes karet di pagi hari' },
      stats: [
    ...
    },
    {
      ...
      image: { src: '/images/potentials/editorial_documentary_photograph_of_a_local_village_umkm_workshop_small_medium.png', alt: 'Pengrajin UMKM Desa Air Putih' },
      stats: [
    ...
    },
    {
      ...
      image: { src: '/images/potentials/editorial_documentary_photograph_of_the_harvest_season_in_desa_air_putih_riau.png', alt: 'Musim panen di Desa Air Putih' },
      stats: [
