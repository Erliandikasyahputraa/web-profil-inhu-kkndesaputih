export const natureContent = {
  ...
  image: '/images/potentials/editorial_documentary_landscape_photograph_of_a_vast_palm_oil_plantation_in.png',
  imageAlt: 'Hamparan perkebunan kelapa sawit di Desa Air Putih',
