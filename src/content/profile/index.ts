export const profileContent = {
  seo: {
    title: "Profil - Desa Air Putih",
    description: "Memahami jiwa Desa Air Putih. Sebuah potret dokumenter tentang manusia, sejarah, dan nilai kehidupan di tepi Indragiri."
  },
  scene01: {
  ...
  scene02: {
    kicker: "SEBUAH AWAL",
    title: "Ingatan yang Menetap",
    story: [
      "Tidak ada yang ingat pasti kapan rumah pertama dibangun. Namun, setiap orang tua di desa ini akan menceritakan hal yang sama: air yang mengalir memberikan kehidupan.",
  ...
  scene04: {
    kicker: "NILAI",
    title: "Kepercayaan Kami",
    quote: "Kami tidak menuliskan visi dan misi di atas kertas. Kami menanamnya di ladang dan mengajarkannya di meja makan.",
    stories: [
      {
        title: "Tangan yang Terbuka",
        text: "Gotong royong bukanlah program desa. Ia adalah cara kami bertahan hidup. Saat satu atap bocor, sepuluh tetangga datang membawa kayu."
      },
      {
        title: "Hormat pada Tanah",
        text: "Alam memberikan segalanya. Sebagai balasannya, kami mengambil secukupnya dan menjaga sisanya untuk cucu kami esok hari."
      }
    ]
  },
  scene05: {
    kicker: "HARI INI",
    title: "Berdiri dengan Bangga",
