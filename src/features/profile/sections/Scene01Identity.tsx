...
export function Scene01Identity() {
  return (
    <Section variant="default" spacing="none" className="bg-[#1A1A1A] relative min-h-screen md:min-h-[85vh] flex items-center overflow-hidden">
      
      {/* Background Image with Gradient Fade */}
      <div className="absolute inset-0 z-0">
        <EditorialImage 
          image={{ src: '/images/hero/cinematic_wide_shot_of_a_peaceful_river_in_rural_riau_indonesia_surrounded_by.png', alt: 'Perahu di sungai Indragiri' }}
          preset="custom"
          overlay="none"
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10 px-6 pt-32 pb-24 md:py-32 flex flex-col justify-end md:justify-center h-full">
        ...
        <div className="w-full md:w-3/5 lg:w-1/2 flex flex-col gap-6 md:gap-8 mt-auto md:mt-0">
          <h1 className="font-serif text-4xl md:text-5xl lg:text-[4.5rem] leading-[1.1] tracking-tight text-white">
